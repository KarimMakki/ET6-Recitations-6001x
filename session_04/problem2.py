...
#     Args:
#         aList: A list that may contain nested lists at any depth
        
#     Returns:
#         A new list with all nested elements flattened into
        
#     Example:
#         >>> flatten([[1, 'a', ['cat'], 2], [[[3]], 'dog'], 4, 5])
#         [1, 'a', 'cat', 2, 3, 'dog', 4, 5]
#     """
#     # Base case: if aList is empty, return an empty list
#     if not aList:
#         return []
...
#     # If first element is a list, flatten it and combine with the flattened rest
#     if isinstance(first, list):
#         return flatten(first) + flatten(rest)
#     # If first element is not a list, combine it with the flattened rest
#     else:
